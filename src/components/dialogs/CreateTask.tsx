...
const CreateTask: VoidComponent<
  DialogProperties<CreateTaskData, { projectId: string }>
> = (props) => {
  const [title, setTitle] = createSignal("");
  const [priority, setPriority] = createSignal<"normal" | "urgent">("normal");
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                value={priority()}
                onChange={(e) =>
                  setPriority(e.currentTarget.value as "normal" | "urgent")
                }
